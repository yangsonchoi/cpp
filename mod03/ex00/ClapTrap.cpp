...
ClapTrap::ClapTrap()
    : name_(kName), current_hp_(kFullHP),
    current_ep_(kFullEP), attack_damage_(kDefaultAD) {
  cout << get_name() << ": Recompiling my combat code(Default constructor)" << endl;
}
...
void ClapTrap::attack(const std::string& target) {
  cout << get_name() << ": Are you bulletproof or...? Whoops! Guess not!" << endl;
