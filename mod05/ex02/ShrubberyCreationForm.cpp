...
ShrubberyCreationForm::ShrubberyCreationForm(const std::string& name, const int& sign, const int& execute)
...
void ShrubberyCreationForm::BeExecuted(const Bureaucrat& b) const {
  if (signed_ == false)
